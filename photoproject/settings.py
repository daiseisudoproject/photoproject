...
SECRET_KEY = os.getenv('DJANGO_SECRET_KEY', 'default_secret_key_if_not_found')
...
# お使いのものを入力してください
DEFAULT_FROM_EMAIL = 'noreply@example.com'  # メールの送信元のアドレスを入力
EMAIL_HOST = 'smtp.gmail.com'            # GmailのSMPTサーバー　　　
EMAIL_PORT = 587                         # SMPTサーバーのポート番号
EMAIL_HOST_USER = 'findods1@gmail.com'     # Gmailのアドレスを入力
EMAIL_HOST_PASSWORD = os.getenv('FINDODS1_PASSWORD') # Gmailのアプリ用パスワードを入力
